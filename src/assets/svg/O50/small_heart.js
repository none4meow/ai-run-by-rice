...
export const tag = (x, y, text) => {
  ...
  return `
	<path transform="translate(${x},${y})" class="st0" d="M53.7,5.7c-0.3-0.4-6.2-7-14.6-5.2c-5.1,1-9.2,4.8-10.6,9.6C27.1,5.2,23,1.5,17.9,0.4C9.4-1.3,3.6,5.3,3.3,5.7
	...
	<text style="font-size:${fontSize}px;" transform="matrix(1 0 0 1 ${xMatrix} ${yMatrix}) translate(${x},${y})" letter-spacing="0.6" class="st1 st2">${text}</text>
`;
};
