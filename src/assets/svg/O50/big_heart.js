...
export const tag = (x, y, text) => {
  ...
  return `
	<path transform="translate(${x},${y})" class="st0" d="M75.1,7.9c-0.4-0.5-8.7-9.8-20.5-7.3C47.5,2,41.8,7.2,39.8,13.9C37.9,7.2,32.2,2,25,0.5
	...
	<text style="font-size:${fontSize}px;" transform="matrix(1 0 0 1 16.48 35.45) translate(${x},${y})" letter-spacing="0.6" class="st1 st2">${text}</text>
  `;
};
